...
public class WSDLReaderImpl implements WSDLReader {
  ...
  private static final List<String> STYLE_ONE_WAY = Collections.singletonList(Constants.ELEM_INPUT);
  ...
  private static final List<String> STYLE_NOTIFICATION = Collections.singletonList(Constants.ELEM_OUTPUT);
